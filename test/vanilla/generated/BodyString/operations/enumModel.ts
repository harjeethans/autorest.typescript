...
const getNotExpandableOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putNotExpandableOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.enumSpec("Colors", [ 'red color', 'green-color', 'blue_color' ])
};

const getReferencedOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putReferencedOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.enumSpec("Colors", [ 'red color', 'green-color', 'blue_color' ])
};

const getReferencedConstantOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putReferencedConstantOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.RefColorConstant
};
