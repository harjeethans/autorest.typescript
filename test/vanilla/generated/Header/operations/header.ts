...
const paramExistingKeyOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const responseExistingKeyOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const paramProtectedKeyOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const responseProtectedKeyOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const paramIntegerOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const responseIntegerOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const paramLongOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const responseLongOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const paramFloatOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const responseFloatOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const paramDoubleOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const responseDoubleOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const paramBoolOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const responseBoolOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const paramStringOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const responseStringOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const paramDateOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const responseDateOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const paramDatetimeOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const responseDatetimeOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const paramDatetimeRfc1123OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const responseDatetimeRfc1123OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const paramDurationOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const responseDurationOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const paramByteOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const responseByteOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const paramEnumOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const responseEnumOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};

const customRequestIdOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST
};
