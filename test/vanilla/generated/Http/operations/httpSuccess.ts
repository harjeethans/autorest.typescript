...
const head200OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.HEAD
};

const get200OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const put200OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.booleanSpec
};

const patch200OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PATCH,
  requestBodySpec: msRest.booleanSpec
};

const post200OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST,
  requestBodySpec: msRest.booleanSpec
};

const delete200OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.DELETE,
  requestBodySpec: msRest.booleanSpec
};

const put201OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.booleanSpec
};

const post201OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST,
  requestBodySpec: msRest.booleanSpec
};

const put202OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.booleanSpec
};

const patch202OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PATCH,
  requestBodySpec: msRest.booleanSpec
};

const post202OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST,
  requestBodySpec: msRest.booleanSpec
};

const delete202OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.DELETE,
  requestBodySpec: msRest.booleanSpec
};

const head204OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.HEAD
};

const put204OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.booleanSpec
};

const patch204OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PATCH,
  requestBodySpec: msRest.booleanSpec
};

const post204OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST,
  requestBodySpec: msRest.booleanSpec
};

const delete204OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.DELETE,
  requestBodySpec: msRest.booleanSpec
};

const head404OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.HEAD
};
