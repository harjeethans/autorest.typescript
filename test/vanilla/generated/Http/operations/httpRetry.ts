...
const head408OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.HEAD
};

const put500OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.booleanSpec
};

const patch500OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PATCH,
  requestBodySpec: msRest.booleanSpec
};

const get502OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const post503OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST,
  requestBodySpec: msRest.booleanSpec
};

const delete503OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.DELETE,
  requestBodySpec: msRest.booleanSpec
};

const put504OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.booleanSpec
};

const patch504OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PATCH,
  requestBodySpec: msRest.booleanSpec
};
