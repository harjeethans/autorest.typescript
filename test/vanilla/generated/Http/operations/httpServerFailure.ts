...
const head501OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.HEAD
};

const get501OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const post505OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST,
  requestBodySpec: msRest.booleanSpec
};

const delete505OperationSpec: OperationSpec = {
