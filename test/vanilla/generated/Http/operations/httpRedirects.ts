...
const head300OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.HEAD
};

const get300OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const head301OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.HEAD
};

const get301OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const put301OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.booleanSpec
};

const head302OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.HEAD
};

const get302OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const patch302OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PATCH,
  requestBodySpec: msRest.booleanSpec
};

const post303OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST,
  requestBodySpec: msRest.booleanSpec
};

const head307OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.HEAD
};

const get307OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const put307OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.booleanSpec
};

const patch307OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PATCH,
  requestBodySpec: msRest.booleanSpec
};

const post307OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST,
  requestBodySpec: msRest.booleanSpec
};

const delete307OperationSpec: OperationSpec = {
