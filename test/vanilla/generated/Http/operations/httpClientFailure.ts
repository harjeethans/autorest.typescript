...
const head400OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.HEAD
};

const get400OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const put400OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.booleanSpec
};

const patch400OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PATCH,
  requestBodySpec: msRest.booleanSpec
};

const post400OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST,
  requestBodySpec: msRest.booleanSpec
};

const delete400OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.DELETE,
  requestBodySpec: msRest.booleanSpec
};

const head401OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.HEAD
};

const get402OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const get403OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const put404OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.booleanSpec
};

const patch405OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PATCH,
  requestBodySpec: msRest.booleanSpec
};

const post406OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST,
  requestBodySpec: msRest.booleanSpec
};

const delete407OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.DELETE,
  requestBodySpec: msRest.booleanSpec
};

const put409OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.booleanSpec
};

const head410OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.HEAD
};

const get411OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const get412OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const put413OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.booleanSpec
};

const patch414OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PATCH,
  requestBodySpec: msRest.booleanSpec
};

const post415OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.POST,
  requestBodySpec: msRest.booleanSpec
};

const get416OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const delete417OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.DELETE,
  requestBodySpec: msRest.booleanSpec
};

const head429OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.HEAD
};
