...
const getRequiredPathOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putOptionalQueryOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT
};

const putOptionalHeaderOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT
};

const putOptionalBodyOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.stringSpec
};

const getRequiredGlobalPathOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getRequiredGlobalQueryOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getOptionalGlobalQueryOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};
