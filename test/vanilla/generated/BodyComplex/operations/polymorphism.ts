...
const putValidOperationSpec: OperationSpec = {
  ...
  requestBodySpec: TypeSpecs.Fish
};

const getComplicatedOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putComplicatedOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.Salmon
};

const putMissingDiscriminatorOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.Salmon
};

const putValidMissingRequiredOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.Fish
};
