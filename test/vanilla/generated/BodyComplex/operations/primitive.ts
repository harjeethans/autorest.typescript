...
const getIntOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putIntOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.IntWrapper
};

const getLongOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putLongOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.LongWrapper
};

const getFloatOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putFloatOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.FloatWrapper
};

const getDoubleOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putDoubleOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.DoubleWrapper
};

const getBoolOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putBoolOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.BooleanWrapper
};

const getStringOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putStringOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.StringWrapper
};

const getDateOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putDateOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.DateWrapper
};

const getDateTimeOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putDateTimeOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.DatetimeWrapper
};

const getDateTimeRfc1123OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putDateTimeRfc1123OperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.Datetimerfc1123Wrapper
};

const getDurationOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putDurationOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.DurationWrapper
};

const getByteOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putByteOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.ByteWrapper
};
