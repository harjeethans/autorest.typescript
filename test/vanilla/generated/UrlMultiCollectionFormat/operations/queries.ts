...
const arrayStringMultiNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const arrayStringMultiEmptyOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const arrayStringMultiValidOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};
