...
const getAllWithValuesOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getGlobalQueryNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getGlobalAndLocalQueryNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getLocalPathItemQueryNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};
