...
const getBooleanTrueOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getBooleanFalseOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getBooleanNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getIntOneMillionOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getIntNegativeOneMillionOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getIntNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getTenBillionOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getNegativeTenBillionOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getLongNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const floatScientificPositiveOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const floatScientificNegativeOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const floatNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const doubleDecimalPositiveOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const doubleDecimalNegativeOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const doubleNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const stringUnicodeOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const stringUrlEncodedOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const stringEmptyOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const stringNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const enumValidOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const enumNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const byteMultiByteOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const byteEmptyOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const byteNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const dateValidOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const dateNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const dateTimeValidOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const dateTimeNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const arrayStringCsvValidOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const arrayStringCsvNullOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const arrayStringCsvEmptyOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const arrayStringSsvValidOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const arrayStringTsvValidOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const arrayStringPipesValidOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};
