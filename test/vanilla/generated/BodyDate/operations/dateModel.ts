...
const getInvalidDateOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getOverflowDateOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getUnderflowDateOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putMaxDateOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.dateSpec
};

const getMaxDateOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putMinDateOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.dateSpec
};

const getMinDateOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};
