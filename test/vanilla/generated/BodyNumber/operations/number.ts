...
const getInvalidFloatOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getInvalidDoubleOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getInvalidDecimalOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putBigFloatOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.numberSpec
};

const getBigFloatOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putBigDoubleOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.numberSpec
};

const getBigDoubleOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putBigDoublePositiveDecimalOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.numberSpec
};

const getBigDoublePositiveDecimalOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putBigDoubleNegativeDecimalOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.numberSpec
};

const getBigDoubleNegativeDecimalOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putBigDecimalOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.numberSpec
};

const getBigDecimalOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putBigDecimalPositiveDecimalOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.numberSpec
};

const getBigDecimalPositiveDecimalOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putBigDecimalNegativeDecimalOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.numberSpec
};

const getBigDecimalNegativeDecimalOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putSmallFloatOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.numberSpec
};

const getSmallFloatOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putSmallDoubleOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.numberSpec
};

const getSmallDoubleOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putSmallDecimalOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.numberSpec
};

const getSmallDecimalOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};
