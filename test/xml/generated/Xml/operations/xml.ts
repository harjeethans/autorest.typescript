...
const getSimpleOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putSimpleOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.Slideshow
};

const getWrappedListsOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putWrappedListsOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.AppleBarrel
};

const getHeadersOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getEmptyListOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putEmptyListOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.Slideshow
};

const getEmptyWrappedListsOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putEmptyWrappedListsOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.AppleBarrel
};

const getRootListOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putRootListOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.sequenceSpec(TypeSpecs.Banana)
};

const getRootListSingleItemOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putRootListSingleItemOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.sequenceSpec(TypeSpecs.Banana)
};

const getEmptyRootListOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putEmptyRootListOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.sequenceSpec(TypeSpecs.Banana)
};

const getEmptyChildElementOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putEmptyChildElementOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.Banana
};

const listContainersOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const getServicePropertiesOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putServicePropertiesOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: TypeSpecs.StorageServiceProperties
};

const getAclsOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};

const putAclsOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.PUT,
  requestBodySpec: msRest.sequenceSpec(TypeSpecs.SignedIdentifier)
};

const listBlobsOperationSpec: OperationSpec = {
  requestHttpMethod: HttpMethod.GET
};
