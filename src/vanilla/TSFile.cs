...
namespace AutoRest.TypeScript
{
    ...
    public class TSFile
    {
        ...
        /// <param name="from">The source of the types, functions, and values. If not specified, then this will default to "ms-rest-js".</param>
        public void Import(IEnumerable<string> imports, string from = "ms-rest-js")
        {
